...
class CommentsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('comments')->insert([
            'name' => 'Probably still not Johnny',
            'email' => 'johnnyrayalt@gmail.com',
            'comment' => 'word',
            'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
            'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
        ]);
        DB::table('comments')->insert([
            'name' => 'Definitely Not Johnny',
            'email' => 'johnnyrayalt@gmail.com',
            'comment' => 'Yeah my dude I hear you',
            'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
            'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
        ]);
        DB::table('comments')->insert([
            'name' => 'Johnny Ray Alt',
            'email' => 'johnnyrayalt@gmail.com',
            'comment' => 'I dunno man, it\'s all latin to me.',
            'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
            'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
        ]);
        DB::table('comments')->insert([
